<script src="{{ asset('js/modal-publication.js') }}"></script>
  <!--Modal-->
  <div class="modal opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center z-40">
    ...
    <div class="modal-container bg-white w-6/12 shadow-lg z-50" >
      ...
      <div class="modal-close absolute top-0 right-0 cursor-pointer flex flex-col items-center mt-4 mr-4 text-white text-sm z-50" onclick="toggleModal('.modal')">
      ...
      <div class="w-full h-auto" id="print-publication" style="max-height:600px;">
        <!--CONTENT-->
